from newnetwork import Topology as TP
from newnetwork import Request as rq
...
def start(id): 
 ...
 # # print("Packet delivery time for request from a to b is: " + str(myTP.get_request_delivery_time('b','a',testPacket)) + " Seconds")
    ...
    plt.savefig(str(id)+".svg", format='svg')
    # sum = 0 
